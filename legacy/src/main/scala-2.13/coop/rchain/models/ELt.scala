...
final case class ELt(
    ...
    ) extends coop.rchain.models.StacksafeMessage[ELt] with scalapb.lenses.Updatable[ELt] {
    
    override def equals(x: Any): Boolean = {
    
      import coop.rchain.catscontrib.effect.implicits.sEval
    
     coop.rchain.models.EqualM[coop.rchain.models.ELt].equals[cats.Eval](this, x).value
    ...
    override def hashCode(): Int = {
     ...
     coop.rchain.models.HashM[coop.rchain.models.ELt].hash[cats.Eval](this).value
    
    }
    
    
    def mergeFromM[F[_]: cats.effect.Sync](`_input__`: _root_.com.google.protobuf.CodedInputStream): F[coop.rchain.models.ELt] = {
    ...
    def withP1(__v: coop.rchain.models.Par): ELt = copy(p1 = __v)
    def withP2(__v: coop.rchain.models.Par): ELt = copy(p2 = __v)
    ...
    def companion: coop.rchain.models.ELt.type = coop.rchain.models.ELt
    // @@protoc_insertion_point(GeneratedMessage[ELt])
}

object ELt extends scalapb.GeneratedMessageCompanion[coop.rchain.models.ELt] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[coop.rchain.models.ELt] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): coop.rchain.models.ELt = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[coop.rchain.models.ELt] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = RhoTypesProto.javaDescriptor.getMessageTypes().get(30)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = RhoTypesProto.scalaDescriptor.messages(30)
  ...
  lazy val defaultInstance = coop.rchain.models.ELt(
    p1 = coop.rchain.models.Par.defaultInstance,
    p2 = coop.rchain.models.Par.defaultInstance
  )
  implicit class ELtLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.ELt]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, coop.rchain.models.ELt](_l) {
  ...
  ): _root_.coop.rchain.models.ELt = _root_.coop.rchain.models.ELt(
    p1,
    p2
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[ELt])
}
