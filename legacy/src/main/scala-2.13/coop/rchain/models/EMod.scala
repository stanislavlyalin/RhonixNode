...
object EMod extends scalapb.GeneratedMessageCompanion[coop.rchain.models.EMod] {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[coop.rchain.models.EMod] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = RhoTypesProto.javaDescriptor.getMessageTypes().get(27)
  ...
  implicit class EModLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.EMod]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, coop.rchain.models.EMod](_l) {
