...
final case class ReceiveBind(
...
) extends coop.rchain.models.StacksafeMessage[ReceiveBind]
    with scalapb.lenses.Updatable[ReceiveBind] {

  def mergeFromM[F[_]: cats.effect.Sync](
    `_input__`: _root_.com.google.protobuf.CodedInputStream,
  ): F[coop.rchain.models.ReceiveBind] = {
          ...
          for {
            ...
            _      <- _tag__ match {
                        ...
                        case 10  =>
                          for {
                            readValue      <-
                              coop.rchain.models.SafeParser.readMessage(_input__, coop.rchain.models.Par.defaultInstance)
                          ...
                          for {
                            readValue      <-
                              coop.rchain.models.SafeParser
                                .readMessage(_input__, __remainder.getOrElse(coop.rchain.models.Var.defaultInstance))
                            customTypeValue = readValue
  ...
  def addPatterns(__vs: coop.rchain.models.Par*): ReceiveBind                                          = addAllPatterns(__vs)
  def addAllPatterns(__vs: Iterable[coop.rchain.models.Par]): ReceiveBind                              = copy(patterns = patterns ++ __vs)
  def withPatterns(__v: _root_.scala.Seq[coop.rchain.models.Par]): ReceiveBind                         = copy(patterns = __v)
  def withSource(__v: coop.rchain.models.Par): ReceiveBind                                             = copy(source = __v)
  def getRemainder: coop.rchain.models.Var                                                             = remainder.getOrElse(coop.rchain.models.Var.defaultInstance)
  def clearRemainder: ReceiveBind                                                                      = copy(remainder = _root_.scala.None)
  def withRemainder(__v: coop.rchain.models.Var): ReceiveBind                                          = copy(remainder = Option(__v))
  def withFreeCount(__v: _root_.scala.Int): ReceiveBind                                                = copy(freeCount = __v)
  ...
  def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
    ...
    (__field.number: @ _root_.scala.unchecked) match {
      ...
      case 3 => remainder.map(_.toPMessage).getOrElse(_root_.scalapb.descriptors.PEmpty)
      case 4 => _root_.scalapb.descriptors.PInt(freeCount)
    }
  }
  def toProtoString: _root_.scala.Predef.String                                                        = _root_.scalapb.TextFormat.printToUnicodeString(this)
  def companion: coop.rchain.models.ReceiveBind.type                                                   = coop.rchain.models.ReceiveBind
  // @@protoc_insertion_point(GeneratedMessage[ReceiveBind])
}

object ReceiveBind extends scalapb.GeneratedMessageCompanion[coop.rchain.models.ReceiveBind] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[coop.rchain.models.ReceiveBind]            = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): coop.rchain.models.ReceiveBind      = {
    val __patterns: _root_.scala.collection.immutable.VectorBuilder[coop.rchain.models.Par] =
      new _root_.scala.collection.immutable.VectorBuilder[coop.rchain.models.Par]
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 18  =>
          __source = _root_.scala.Some(
            __source.fold(_root_.scalapb.LiteParser.readMessage[coop.rchain.models.Par](_input__))(
              _root_.scalapb.LiteParser.readMessage(_input__, _),
            ),
          )
        case 26  =>
          __remainder = Option(
            __remainder.fold(_root_.scalapb.LiteParser.readMessage[coop.rchain.models.Var](_input__))(
              _root_.scalapb.LiteParser.readMessage(_input__, _),
            ),
          )
        case 32  =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[coop.rchain.models.ReceiveBind]                 =
    _root_.scalapb.descriptors.Reads {
      case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
        ...
        coop.rchain.models.ReceiveBind(
          patterns = __fieldsMap
            .get(scalaDescriptor.findFieldByNumber(1).get)
            .map(_.as[_root_.scala.Seq[coop.rchain.models.Par]])
          ...
          remainder = __fieldsMap
            .get(scalaDescriptor.findFieldByNumber(3).get)
            .flatMap(_.as[_root_.scala.Option[coop.rchain.models.Var]]),
          freeCount = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).map(_.as[_root_.scala.Int]).getOrElse(0),
        )
      case _                                                => throw new RuntimeException("Expected PMessage")
    }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor                                       =
    RhoTypesProto.javaDescriptor.getMessageTypes().get(8)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor                                                  = RhoTypesProto.scalaDescriptor.messages(8)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
    (__number: @ _root_.scala.unchecked) match {
      case 1 => __out = coop.rchain.models.Par
      case 2 => __out = coop.rchain.models.Par
      case 3 => __out = coop.rchain.models.Var
    }
    __out
  }
  ...
  lazy val defaultInstance                                                                                    = coop.rchain.models.ReceiveBind(
    patterns = _root_.scala.Seq.empty,
    source = coop.rchain.models.Par.defaultInstance,
    remainder = _root_.scala.None,
    freeCount = 0,
  )
  implicit class ReceiveBindLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.ReceiveBind])
      extends _root_.scalapb.lenses.ObjectLens[UpperPB, coop.rchain.models.ReceiveBind](_l) {
    def patterns: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[coop.rchain.models.Par]]             =
      field(_.patterns)((c_, f_) => c_.copy(patterns = f_))
    def source: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.Par]                                 =
      field(_.source)((c_, f_) => c_.copy(source = f_))
    def remainder: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.Var]                              =
      field(_.getRemainder)((c_, f_) => c_.copy(remainder = Option(f_)))
    def optionalRemainder: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[coop.rchain.models.Var]] =
      field(_.remainder)((c_, f_) => c_.copy(remainder = f_))
    def freeCount: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Int]                                    =
      field(_.freeCount)((c_, f_) => c_.copy(freeCount = f_))
  }
  final val PATTERNS_FIELD_NUMBER = 1
  final val SOURCE_FIELD_NUMBER    = 2
  final val REMAINDER_FIELD_NUMBER = 3
  final val FREECOUNT_FIELD_NUMBER = 4
  def of(
  ...
  ): _root_.coop.rchain.models.ReceiveBind = _root_.coop.rchain.models.ReceiveBind(
    patterns,
    source,
    remainder,
    freeCount,
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[ReceiveBind])
}
