...
final case class EMult(
    ...
    ) extends coop.rchain.models.StacksafeMessage[EMult] with scalapb.lenses.Updatable[EMult] {
    
    override def equals(x: Any): Boolean = {
    
      import coop.rchain.catscontrib.effect.implicits.sEval
    
     coop.rchain.models.EqualM[coop.rchain.models.EMult].equals[cats.Eval](this, x).value
    ...
    override def hashCode(): Int = {
     ...
     coop.rchain.models.HashM[coop.rchain.models.EMult].hash[cats.Eval](this).value
    
    }
    
    
    def mergeFromM[F[_]: cats.effect.Sync](`_input__`: _root_.com.google.protobuf.CodedInputStream): F[coop.rchain.models.EMult] = {
      ...
      Sync[F].defer {
        ...
        .map { _ => coop.rchain.models.EMult(
          p1 = __p1,
          p2 = __p2
        )}
      }
    ...
    def withP1(__v: coop.rchain.models.Par): EMult = copy(p1 = __v)
    def withP2(__v: coop.rchain.models.Par): EMult = copy(p2 = __v)
    ...
    def companion: coop.rchain.models.EMult.type = coop.rchain.models.EMult
    // @@protoc_insertion_point(GeneratedMessage[EMult])
}

object EMult extends scalapb.GeneratedMessageCompanion[coop.rchain.models.EMult] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[coop.rchain.models.EMult] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): coop.rchain.models.EMult = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[coop.rchain.models.EMult] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = RhoTypesProto.javaDescriptor.getMessageTypes().get(25)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = RhoTypesProto.scalaDescriptor.messages(25)
  ...
  lazy val defaultInstance = coop.rchain.models.EMult(
    p1 = coop.rchain.models.Par.defaultInstance,
    p2 = coop.rchain.models.Par.defaultInstance
  )
  implicit class EMultLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.EMult]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, coop.rchain.models.EMult](_l) {
  ...
  ): _root_.coop.rchain.models.EMult = _root_.coop.rchain.models.EMult(
    p1,
    p2
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[EMult])
}
