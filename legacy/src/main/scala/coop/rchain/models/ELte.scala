...
final case class ELte(
    ...
    ) extends coop.rchain.models.StacksafeMessage[ELte] with scalapb.lenses.Updatable[ELte] {
    
    override def equals(x: Any): Boolean = {
    
      import coop.rchain.catscontrib.effect.implicits.sEval
    
     coop.rchain.models.EqualM[coop.rchain.models.ELte].equals[cats.Eval](this, x).value
    ...
    override def hashCode(): Int = {
     ...
     coop.rchain.models.HashM[coop.rchain.models.ELte].hash[cats.Eval](this).value
    
    }
    
    
    def mergeFromM[F[_]: cats.effect.Sync](`_input__`: _root_.com.google.protobuf.CodedInputStream): F[coop.rchain.models.ELte] = {
    ...
    def withP1(__v: coop.rchain.models.Par): ELte = copy(p1 = __v)
    def withP2(__v: coop.rchain.models.Par): ELte = copy(p2 = __v)
    ...
    def companion: coop.rchain.models.ELte.type = coop.rchain.models.ELte
    // @@protoc_insertion_point(GeneratedMessage[ELte])
}

object ELte extends scalapb.GeneratedMessageCompanion[coop.rchain.models.ELte] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[coop.rchain.models.ELte] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): coop.rchain.models.ELte = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[coop.rchain.models.ELte] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = RhoTypesProto.javaDescriptor.getMessageTypes().get(31)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = RhoTypesProto.scalaDescriptor.messages(31)
  ...
  lazy val defaultInstance = coop.rchain.models.ELte(
    p1 = coop.rchain.models.Par.defaultInstance,
    p2 = coop.rchain.models.Par.defaultInstance
  )
  implicit class ELteLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.ELte]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, coop.rchain.models.ELte](_l) {
  ...
  ): _root_.coop.rchain.models.ELte = _root_.coop.rchain.models.ELte(
    p1,
    p2
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[ELte])
}
