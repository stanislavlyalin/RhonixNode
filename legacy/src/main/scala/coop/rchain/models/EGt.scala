...
final case class EGt(
    ...
    ) extends coop.rchain.models.StacksafeMessage[EGt] with scalapb.lenses.Updatable[EGt] {
    
    override def equals(x: Any): Boolean = {
    
      import coop.rchain.catscontrib.effect.implicits.sEval
    
     coop.rchain.models.EqualM[coop.rchain.models.EGt].equals[cats.Eval](this, x).value
    ...
    override def hashCode(): Int = {
     ...
     coop.rchain.models.HashM[coop.rchain.models.EGt].hash[cats.Eval](this).value
    
    }
    
    
    def mergeFromM[F[_]: cats.effect.Sync](`_input__`: _root_.com.google.protobuf.CodedInputStream): F[coop.rchain.models.EGt] = {
    ...
    def withP1(__v: coop.rchain.models.Par): EGt = copy(p1 = __v)
    def withP2(__v: coop.rchain.models.Par): EGt = copy(p2 = __v)
    ...
    def companion: coop.rchain.models.EGt.type = coop.rchain.models.EGt
    // @@protoc_insertion_point(GeneratedMessage[EGt])
}

object EGt extends scalapb.GeneratedMessageCompanion[coop.rchain.models.EGt] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[coop.rchain.models.EGt] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): coop.rchain.models.EGt = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[coop.rchain.models.EGt] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = RhoTypesProto.javaDescriptor.getMessageTypes().get(32)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = RhoTypesProto.scalaDescriptor.messages(32)
  ...
  lazy val defaultInstance = coop.rchain.models.EGt(
    p1 = coop.rchain.models.Par.defaultInstance,
    p2 = coop.rchain.models.Par.defaultInstance
  )
  implicit class EGtLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.EGt]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, coop.rchain.models.EGt](_l) {
  ...
  ): _root_.coop.rchain.models.EGt = _root_.coop.rchain.models.EGt(
    p1,
    p2
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[EGt])
}
