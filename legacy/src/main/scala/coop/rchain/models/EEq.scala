...
final case class EEq(
    ...
    ) extends coop.rchain.models.StacksafeMessage[EEq] with scalapb.lenses.Updatable[EEq] {
    
    override def equals(x: Any): Boolean = {
    
      import coop.rchain.catscontrib.effect.implicits.sEval
    
     coop.rchain.models.EqualM[coop.rchain.models.EEq].equals[cats.Eval](this, x).value
    ...
    override def hashCode(): Int = {
     ...
     coop.rchain.models.HashM[coop.rchain.models.EEq].hash[cats.Eval](this).value
    
    }
    
    
    def mergeFromM[F[_]: cats.effect.Sync](`_input__`: _root_.com.google.protobuf.CodedInputStream): F[coop.rchain.models.EEq] = {
    ...
    def withP1(__v: coop.rchain.models.Par): EEq = copy(p1 = __v)
    def withP2(__v: coop.rchain.models.Par): EEq = copy(p2 = __v)
    ...
    def companion: coop.rchain.models.EEq.type = coop.rchain.models.EEq
    // @@protoc_insertion_point(GeneratedMessage[EEq])
}

object EEq extends scalapb.GeneratedMessageCompanion[coop.rchain.models.EEq] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[coop.rchain.models.EEq] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): coop.rchain.models.EEq = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[coop.rchain.models.EEq] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = RhoTypesProto.javaDescriptor.getMessageTypes().get(34)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = RhoTypesProto.scalaDescriptor.messages(34)
  ...
  lazy val defaultInstance = coop.rchain.models.EEq(
    p1 = coop.rchain.models.Par.defaultInstance,
    p2 = coop.rchain.models.Par.defaultInstance
  )
  implicit class EEqLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.EEq]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, coop.rchain.models.EEq](_l) {
  ...
  ): _root_.coop.rchain.models.EEq = _root_.coop.rchain.models.EEq(
    p1,
    p2
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[EEq])
}
