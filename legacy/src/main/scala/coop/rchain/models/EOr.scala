...
final case class EOr(
    ...
    ) extends coop.rchain.models.StacksafeMessage[EOr] with scalapb.lenses.Updatable[EOr] {
    
    override def equals(x: Any): Boolean = {
    
      import coop.rchain.catscontrib.effect.implicits.sEval
    
     coop.rchain.models.EqualM[coop.rchain.models.EOr].equals[cats.Eval](this, x).value
    ...
    override def hashCode(): Int = {
     ...
     coop.rchain.models.HashM[coop.rchain.models.EOr].hash[cats.Eval](this).value
    
    }
    
    
    def mergeFromM[F[_]: cats.effect.Sync](`_input__`: _root_.com.google.protobuf.CodedInputStream): F[coop.rchain.models.EOr] = {
    ...
    def withP1(__v: coop.rchain.models.Par): EOr = copy(p1 = __v)
    def withP2(__v: coop.rchain.models.Par): EOr = copy(p2 = __v)
    ...
    def companion: coop.rchain.models.EOr.type = coop.rchain.models.EOr
    // @@protoc_insertion_point(GeneratedMessage[EOr])
}

object EOr extends scalapb.GeneratedMessageCompanion[coop.rchain.models.EOr] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[coop.rchain.models.EOr] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): coop.rchain.models.EOr = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[coop.rchain.models.EOr] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = RhoTypesProto.javaDescriptor.getMessageTypes().get(37)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = RhoTypesProto.scalaDescriptor.messages(37)
  ...
  lazy val defaultInstance = coop.rchain.models.EOr(
    p1 = coop.rchain.models.Par.defaultInstance,
    p2 = coop.rchain.models.Par.defaultInstance
  )
  implicit class EOrLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.EOr]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, coop.rchain.models.EOr](_l) {
  ...
  ): _root_.coop.rchain.models.EOr = _root_.coop.rchain.models.EOr(
    p1,
    p2
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[EOr])
}
