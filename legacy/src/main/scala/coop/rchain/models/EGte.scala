...
final case class EGte(
    ...
    ) extends coop.rchain.models.StacksafeMessage[EGte] with scalapb.lenses.Updatable[EGte] {
    
    override def equals(x: Any): Boolean = {
    
      import coop.rchain.catscontrib.effect.implicits.sEval
    
     coop.rchain.models.EqualM[coop.rchain.models.EGte].equals[cats.Eval](this, x).value
    ...
    override def hashCode(): Int = {
     ...
     coop.rchain.models.HashM[coop.rchain.models.EGte].hash[cats.Eval](this).value
    
    }
    
    
    def mergeFromM[F[_]: cats.effect.Sync](`_input__`: _root_.com.google.protobuf.CodedInputStream): F[coop.rchain.models.EGte] = {
    ...
    def withP1(__v: coop.rchain.models.Par): EGte = copy(p1 = __v)
    def withP2(__v: coop.rchain.models.Par): EGte = copy(p2 = __v)
    ...
    def companion: coop.rchain.models.EGte.type = coop.rchain.models.EGte
    // @@protoc_insertion_point(GeneratedMessage[EGte])
}

object EGte extends scalapb.GeneratedMessageCompanion[coop.rchain.models.EGte] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[coop.rchain.models.EGte] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): coop.rchain.models.EGte = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[coop.rchain.models.EGte] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = RhoTypesProto.javaDescriptor.getMessageTypes().get(33)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = RhoTypesProto.scalaDescriptor.messages(33)
  ...
  lazy val defaultInstance = coop.rchain.models.EGte(
    p1 = coop.rchain.models.Par.defaultInstance,
    p2 = coop.rchain.models.Par.defaultInstance
  )
  implicit class EGteLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.EGte]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, coop.rchain.models.EGte](_l) {
  ...
  ): _root_.coop.rchain.models.EGte = _root_.coop.rchain.models.EGte(
    p1,
    p2
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[EGte])
}
