...
final case class EShortAnd(
    ...
    ) extends coop.rchain.models.StacksafeMessage[EShortAnd] with scalapb.lenses.Updatable[EShortAnd] {
    
    override def equals(x: Any): Boolean = {
    
      import coop.rchain.catscontrib.effect.implicits.sEval
    
     coop.rchain.models.EqualM[coop.rchain.models.EShortAnd].equals[cats.Eval](this, x).value
    ...
    override def hashCode(): Int = {
     ...
     coop.rchain.models.HashM[coop.rchain.models.EShortAnd].hash[cats.Eval](this).value
    
    }
    
    
    def mergeFromM[F[_]: cats.effect.Sync](`_input__`: _root_.com.google.protobuf.CodedInputStream): F[coop.rchain.models.EShortAnd] = {
      ...
      Sync[F].defer {
        ...
        .map { _ => coop.rchain.models.EShortAnd(
          p1 = __p1,
          p2 = __p2
        )}
      }
    ...
    def withP1(__v: coop.rchain.models.Par): EShortAnd = copy(p1 = __v)
    def withP2(__v: coop.rchain.models.Par): EShortAnd = copy(p2 = __v)
    ...
    def companion: coop.rchain.models.EShortAnd.type = coop.rchain.models.EShortAnd
    // @@protoc_insertion_point(GeneratedMessage[EShortAnd])
}

object EShortAnd extends scalapb.GeneratedMessageCompanion[coop.rchain.models.EShortAnd] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[coop.rchain.models.EShortAnd] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): coop.rchain.models.EShortAnd = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[coop.rchain.models.EShortAnd] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = RhoTypesProto.javaDescriptor.getMessageTypes().get(38)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = RhoTypesProto.scalaDescriptor.messages(38)
  ...
  lazy val defaultInstance = coop.rchain.models.EShortAnd(
    p1 = coop.rchain.models.Par.defaultInstance,
    p2 = coop.rchain.models.Par.defaultInstance
  )
  implicit class EShortAndLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.EShortAnd]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, coop.rchain.models.EShortAnd](_l) {
  ...
  ): _root_.coop.rchain.models.EShortAnd = _root_.coop.rchain.models.EShortAnd(
    p1,
    p2
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[EShortAnd])
}
