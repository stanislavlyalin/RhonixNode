...
final case class EPlus(
    ...
    ) extends coop.rchain.models.StacksafeMessage[EPlus] with scalapb.lenses.Updatable[EPlus] {
    
    override def equals(x: Any): Boolean = {
    
      import coop.rchain.catscontrib.effect.implicits.sEval
    
     coop.rchain.models.EqualM[coop.rchain.models.EPlus].equals[cats.Eval](this, x).value
    ...
    override def hashCode(): Int = {
     ...
     coop.rchain.models.HashM[coop.rchain.models.EPlus].hash[cats.Eval](this).value
    
    }
    
    
    def mergeFromM[F[_]: cats.effect.Sync](`_input__`: _root_.com.google.protobuf.CodedInputStream): F[coop.rchain.models.EPlus] = {
      ...
      Sync[F].defer {
        ...
        .map { _ => coop.rchain.models.EPlus(
          p1 = __p1,
          p2 = __p2
        )}
      }
    ...
    def withP1(__v: coop.rchain.models.Par): EPlus = copy(p1 = __v)
    def withP2(__v: coop.rchain.models.Par): EPlus = copy(p2 = __v)
    ...
    def companion: coop.rchain.models.EPlus.type = coop.rchain.models.EPlus
    // @@protoc_insertion_point(GeneratedMessage[EPlus])
}

object EPlus extends scalapb.GeneratedMessageCompanion[coop.rchain.models.EPlus] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[coop.rchain.models.EPlus] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): coop.rchain.models.EPlus = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[coop.rchain.models.EPlus] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = RhoTypesProto.javaDescriptor.getMessageTypes().get(28)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = RhoTypesProto.scalaDescriptor.messages(28)
  ...
  lazy val defaultInstance = coop.rchain.models.EPlus(
    p1 = coop.rchain.models.Par.defaultInstance,
    p2 = coop.rchain.models.Par.defaultInstance
  )
  implicit class EPlusLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.EPlus]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, coop.rchain.models.EPlus](_l) {
  ...
  ): _root_.coop.rchain.models.EPlus = _root_.coop.rchain.models.EPlus(
    p1,
    p2
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[EPlus])
}
