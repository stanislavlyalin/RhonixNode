...
final case class ReceiveBind(
    ...
    ) extends coop.rchain.models.StacksafeMessage[ReceiveBind] with scalapb.lenses.Updatable[ReceiveBind] {
    
    override def equals(x: Any): Boolean = {
    
      import coop.rchain.catscontrib.effect.implicits.sEval
    
     coop.rchain.models.EqualM[coop.rchain.models.ReceiveBind].equals[cats.Eval](this, x).value
    ...
    override def hashCode(): Int = {
     ...
     coop.rchain.models.HashM[coop.rchain.models.ReceiveBind].hash[cats.Eval](this).value
    
    }
    
    
    def mergeFromM[F[_]: cats.effect.Sync](`_input__`: _root_.com.google.protobuf.CodedInputStream): F[coop.rchain.models.ReceiveBind] = {
      ...
      Sync[F].defer {
        ...
        .map { _ => coop.rchain.models.ReceiveBind(
...
object ReceiveBind extends scalapb.GeneratedMessageCompanion[coop.rchain.models.ReceiveBind] {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[coop.rchain.models.ReceiveBind] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      coop.rchain.models.ReceiveBind(
        ...
        remainder = __fieldsMap.get(scalaDescriptor.findFieldByNumber(3).get).flatMap(_.as[_root_.scala.Option[coop.rchain.models.Var]]),
        freeCount = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).map(_.as[_root_.scala.Int]).getOrElse(0)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = RhoTypesProto.javaDescriptor.getMessageTypes().get(8)
  ...
  implicit class ReceiveBindLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.ReceiveBind]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, coop.rchain.models.ReceiveBind](_l) {
