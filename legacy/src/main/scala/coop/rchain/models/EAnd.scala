...
final case class EAnd(
    ...
    ) extends coop.rchain.models.StacksafeMessage[EAnd] with scalapb.lenses.Updatable[EAnd] {
    
    override def equals(x: Any): Boolean = {
    
      import coop.rchain.catscontrib.effect.implicits.sEval
    
     coop.rchain.models.EqualM[coop.rchain.models.EAnd].equals[cats.Eval](this, x).value
    ...
    override def hashCode(): Int = {
     ...
     coop.rchain.models.HashM[coop.rchain.models.EAnd].hash[cats.Eval](this).value
    
    }
    
    
    def mergeFromM[F[_]: cats.effect.Sync](`_input__`: _root_.com.google.protobuf.CodedInputStream): F[coop.rchain.models.EAnd] = {
    ...
    def withP1(__v: coop.rchain.models.Par): EAnd = copy(p1 = __v)
    def withP2(__v: coop.rchain.models.Par): EAnd = copy(p2 = __v)
    ...
    def companion: coop.rchain.models.EAnd.type = coop.rchain.models.EAnd
    // @@protoc_insertion_point(GeneratedMessage[EAnd])
}

object EAnd extends scalapb.GeneratedMessageCompanion[coop.rchain.models.EAnd] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[coop.rchain.models.EAnd] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): coop.rchain.models.EAnd = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[coop.rchain.models.EAnd] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = RhoTypesProto.javaDescriptor.getMessageTypes().get(36)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = RhoTypesProto.scalaDescriptor.messages(36)
  ...
  lazy val defaultInstance = coop.rchain.models.EAnd(
    p1 = coop.rchain.models.Par.defaultInstance,
    p2 = coop.rchain.models.Par.defaultInstance
  )
  implicit class EAndLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.EAnd]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, coop.rchain.models.EAnd](_l) {
  ...
  ): _root_.coop.rchain.models.EAnd = _root_.coop.rchain.models.EAnd(
    p1,
    p2
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[EAnd])
}
