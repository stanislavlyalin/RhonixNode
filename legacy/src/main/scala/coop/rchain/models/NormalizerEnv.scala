...
object NormalizerEnv {
  ...
  object ToParList {
    ...
    implicit def hListToParList[H, T <: HList](implicit
      ev: H => Par,
  ...
  object ToEnvMap {
    ...
    implicit def summon[K <: HList, V <: HList, Env <: HList](implicit
      K: Keys.Aux[Env, K],
      V: Values.Aux[Env, V],
  ...
  object Contains {
    ...
    implicit def summon[Env <: HList, Key, T](implicit
      selector: Selector.Aux[Env, Key, T],
