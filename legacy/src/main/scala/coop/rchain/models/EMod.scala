...
final case class EMod(
...
) extends coop.rchain.models.StacksafeMessage[EMod]
    with scalapb.lenses.Updatable[EMod] {
  ...
  def withP1(__v: coop.rchain.models.Par): EMod                                                        = copy(p1 = __v)
  def withP2(__v: coop.rchain.models.Par): EMod                                                        = copy(p2 = __v)
  ...
  def companion: coop.rchain.models.EMod.type                                                          = coop.rchain.models.EMod
  // @@protoc_insertion_point(GeneratedMessage[EMod])
}

object EMod extends scalapb.GeneratedMessageCompanion[coop.rchain.models.EMod] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[coop.rchain.models.EMod]                   = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): coop.rchain.models.EMod             = {
    ...
    while (!_done__) {
      ...
      _tag__ match {
        case 0   => _done__ = true
        case 10  =>
          __p1 = _root_.scala.Some(
            __p1.fold(_root_.scalapb.LiteParser.readMessage[coop.rchain.models.Par](_input__))(
              _root_.scalapb.LiteParser.readMessage(_input__, _),
            ),
          )
        case 18  =>
          __p2 = _root_.scala.Some(
            __p2.fold(_root_.scalapb.LiteParser.readMessage[coop.rchain.models.Par](_input__))(
              _root_.scalapb.LiteParser.readMessage(_input__, _),
            ),
          )
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[coop.rchain.models.EMod]                        =
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor                                       =
    RhoTypesProto.javaDescriptor.getMessageTypes().get(27)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor                                                  = RhoTypesProto.scalaDescriptor.messages(27)
  ...
  lazy val defaultInstance                                                                                    = coop.rchain.models.EMod(
    p1 = coop.rchain.models.Par.defaultInstance,
    p2 = coop.rchain.models.Par.defaultInstance,
  )
  implicit class EModLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.EMod])
      extends _root_.scalapb.lenses.ObjectLens[UpperPB, coop.rchain.models.EMod](_l) {
  ...
  ): _root_.coop.rchain.models.EMod = _root_.coop.rchain.models.EMod(
    p1,
    p2,
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[EMod])
}
