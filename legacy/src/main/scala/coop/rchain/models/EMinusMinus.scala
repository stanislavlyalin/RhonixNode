...
final case class EMinusMinus(
    ...
    ) extends coop.rchain.models.StacksafeMessage[EMinusMinus] with scalapb.lenses.Updatable[EMinusMinus] {
    
    override def equals(x: Any): Boolean = {
    
      import coop.rchain.catscontrib.effect.implicits.sEval
    
     coop.rchain.models.EqualM[coop.rchain.models.EMinusMinus].equals[cats.Eval](this, x).value
    ...
    override def hashCode(): Int = {
     ...
     coop.rchain.models.HashM[coop.rchain.models.EMinusMinus].hash[cats.Eval](this).value
    
    }
    
    
    def mergeFromM[F[_]: cats.effect.Sync](`_input__`: _root_.com.google.protobuf.CodedInputStream): F[coop.rchain.models.EMinusMinus] = {
      ...
      Sync[F].defer {
        ...
        .map { _ => coop.rchain.models.EMinusMinus(
          p1 = __p1,
          p2 = __p2
        )}
      }
    ...
    def withP1(__v: coop.rchain.models.Par): EMinusMinus = copy(p1 = __v)
    def withP2(__v: coop.rchain.models.Par): EMinusMinus = copy(p2 = __v)
    ...
    def companion: coop.rchain.models.EMinusMinus.type = coop.rchain.models.EMinusMinus
    // @@protoc_insertion_point(GeneratedMessage[EMinusMinus])
}

object EMinusMinus extends scalapb.GeneratedMessageCompanion[coop.rchain.models.EMinusMinus] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[coop.rchain.models.EMinusMinus] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): coop.rchain.models.EMinusMinus = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[coop.rchain.models.EMinusMinus] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = RhoTypesProto.javaDescriptor.getMessageTypes().get(43)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = RhoTypesProto.scalaDescriptor.messages(43)
  ...
  lazy val defaultInstance = coop.rchain.models.EMinusMinus(
    p1 = coop.rchain.models.Par.defaultInstance,
    p2 = coop.rchain.models.Par.defaultInstance
  )
  implicit class EMinusMinusLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.EMinusMinus]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, coop.rchain.models.EMinusMinus](_l) {
  ...
  ): _root_.coop.rchain.models.EMinusMinus = _root_.coop.rchain.models.EMinusMinus(
    p1,
    p2
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[EMinusMinus])
}
