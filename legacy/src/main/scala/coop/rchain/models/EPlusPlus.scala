...
final case class EPlusPlus(
    ...
    ) extends coop.rchain.models.StacksafeMessage[EPlusPlus] with scalapb.lenses.Updatable[EPlusPlus] {
    
    override def equals(x: Any): Boolean = {
    
      import coop.rchain.catscontrib.effect.implicits.sEval
    
     coop.rchain.models.EqualM[coop.rchain.models.EPlusPlus].equals[cats.Eval](this, x).value
    ...
    override def hashCode(): Int = {
     ...
     coop.rchain.models.HashM[coop.rchain.models.EPlusPlus].hash[cats.Eval](this).value
    
    }
    
    
    def mergeFromM[F[_]: cats.effect.Sync](`_input__`: _root_.com.google.protobuf.CodedInputStream): F[coop.rchain.models.EPlusPlus] = {
      ...
      Sync[F].defer {
        ...
        .map { _ => coop.rchain.models.EPlusPlus(
          p1 = __p1,
          p2 = __p2
        )}
      }
    ...
    def withP1(__v: coop.rchain.models.Par): EPlusPlus = copy(p1 = __v)
    def withP2(__v: coop.rchain.models.Par): EPlusPlus = copy(p2 = __v)
    ...
    def companion: coop.rchain.models.EPlusPlus.type = coop.rchain.models.EPlusPlus
    // @@protoc_insertion_point(GeneratedMessage[EPlusPlus])
}

object EPlusPlus extends scalapb.GeneratedMessageCompanion[coop.rchain.models.EPlusPlus] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[coop.rchain.models.EPlusPlus] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): coop.rchain.models.EPlusPlus = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[coop.rchain.models.EPlusPlus] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = RhoTypesProto.javaDescriptor.getMessageTypes().get(42)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = RhoTypesProto.scalaDescriptor.messages(42)
  ...
  lazy val defaultInstance = coop.rchain.models.EPlusPlus(
    p1 = coop.rchain.models.Par.defaultInstance,
    p2 = coop.rchain.models.Par.defaultInstance
  )
  implicit class EPlusPlusLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.EPlusPlus]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, coop.rchain.models.EPlusPlus](_l) {
  ...
  ): _root_.coop.rchain.models.EPlusPlus = _root_.coop.rchain.models.EPlusPlus(
    p1,
    p2
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[EPlusPlus])
}
