...
final case class ENeq(
    ...
    ) extends coop.rchain.models.StacksafeMessage[ENeq] with scalapb.lenses.Updatable[ENeq] {
    
    override def equals(x: Any): Boolean = {
    
      import coop.rchain.catscontrib.effect.implicits.sEval
    
     coop.rchain.models.EqualM[coop.rchain.models.ENeq].equals[cats.Eval](this, x).value
    ...
    override def hashCode(): Int = {
     ...
     coop.rchain.models.HashM[coop.rchain.models.ENeq].hash[cats.Eval](this).value
    
    }
    
    
    def mergeFromM[F[_]: cats.effect.Sync](`_input__`: _root_.com.google.protobuf.CodedInputStream): F[coop.rchain.models.ENeq] = {
    ...
    def withP1(__v: coop.rchain.models.Par): ENeq = copy(p1 = __v)
    def withP2(__v: coop.rchain.models.Par): ENeq = copy(p2 = __v)
    ...
    def companion: coop.rchain.models.ENeq.type = coop.rchain.models.ENeq
    // @@protoc_insertion_point(GeneratedMessage[ENeq])
}

object ENeq extends scalapb.GeneratedMessageCompanion[coop.rchain.models.ENeq] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[coop.rchain.models.ENeq] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): coop.rchain.models.ENeq = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[coop.rchain.models.ENeq] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = RhoTypesProto.javaDescriptor.getMessageTypes().get(35)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = RhoTypesProto.scalaDescriptor.messages(35)
  ...
  lazy val defaultInstance = coop.rchain.models.ENeq(
    p1 = coop.rchain.models.Par.defaultInstance,
    p2 = coop.rchain.models.Par.defaultInstance
  )
  implicit class ENeqLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.ENeq]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, coop.rchain.models.ENeq](_l) {
  ...
  ): _root_.coop.rchain.models.ENeq = _root_.coop.rchain.models.ENeq(
    p1,
    p2
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[ENeq])
}
