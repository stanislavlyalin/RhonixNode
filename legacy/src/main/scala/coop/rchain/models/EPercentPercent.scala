...
final case class EPercentPercent(
    ...
    ) extends coop.rchain.models.StacksafeMessage[EPercentPercent] with scalapb.lenses.Updatable[EPercentPercent] {
    
    override def equals(x: Any): Boolean = {
    
      import coop.rchain.catscontrib.effect.implicits.sEval
    
     coop.rchain.models.EqualM[coop.rchain.models.EPercentPercent].equals[cats.Eval](this, x).value
    ...
    override def hashCode(): Int = {
     ...
     coop.rchain.models.HashM[coop.rchain.models.EPercentPercent].hash[cats.Eval](this).value
    
    }
    
    
    def mergeFromM[F[_]: cats.effect.Sync](`_input__`: _root_.com.google.protobuf.CodedInputStream): F[coop.rchain.models.EPercentPercent] = {
      ...
      Sync[F].defer {
        ...
        .map { _ => coop.rchain.models.EPercentPercent(
          p1 = __p1,
          p2 = __p2
        )}
      }
    ...
    def withP1(__v: coop.rchain.models.Par): EPercentPercent = copy(p1 = __v)
    def withP2(__v: coop.rchain.models.Par): EPercentPercent = copy(p2 = __v)
    ...
    def companion: coop.rchain.models.EPercentPercent.type = coop.rchain.models.EPercentPercent
    // @@protoc_insertion_point(GeneratedMessage[EPercentPercent])
}

object EPercentPercent extends scalapb.GeneratedMessageCompanion[coop.rchain.models.EPercentPercent] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[coop.rchain.models.EPercentPercent] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): coop.rchain.models.EPercentPercent = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[coop.rchain.models.EPercentPercent] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = RhoTypesProto.javaDescriptor.getMessageTypes().get(41)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = RhoTypesProto.scalaDescriptor.messages(41)
  ...
  lazy val defaultInstance = coop.rchain.models.EPercentPercent(
    p1 = coop.rchain.models.Par.defaultInstance,
    p2 = coop.rchain.models.Par.defaultInstance
  )
  implicit class EPercentPercentLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.EPercentPercent]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, coop.rchain.models.EPercentPercent](_l) {
  ...
  ): _root_.coop.rchain.models.EPercentPercent = _root_.coop.rchain.models.EPercentPercent(
    p1,
    p2
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[EPercentPercent])
}
