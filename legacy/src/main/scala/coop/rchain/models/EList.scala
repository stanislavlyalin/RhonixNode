...
final case class EList(
    ...
    locallyFree: coop.rchain.models.AlwaysEqual[scala.collection.immutable.BitSet] = coop.rchain.models.EList._typemapper_locallyFree.toCustom(_root_.com.google.protobuf.ByteString.EMPTY),
    connectiveUsed: _root_.scala.Boolean = false,
    remainder: _root_.scala.Option[coop.rchain.models.Var] = _root_.scala.None
    ) extends coop.rchain.models.StacksafeMessage[EList] with scalapb.lenses.Updatable[EList] {
    
    override def equals(x: Any): Boolean = {
    
      import coop.rchain.catscontrib.effect.implicits.sEval
    
     coop.rchain.models.EqualM[coop.rchain.models.EList].equals[cats.Eval](this, x).value
    ...
    override def hashCode(): Int = {
     ...
     coop.rchain.models.HashM[coop.rchain.models.EList].hash[cats.Eval](this).value
    
    }
    
    
    def mergeFromM[F[_]: cats.effect.Sync](`_input__`: _root_.com.google.protobuf.CodedInputStream): F[coop.rchain.models.EList] = {
      ...
      Sync[F].defer {
            ...
            _ <- _tag__ match {
              ...
              case 26 =>
                for {
                  ...
                  customTypeValue =  coop.rchain.models.EList._typemapper_locallyFree.toCustom(readValue)
        ...
        .map { _ => coop.rchain.models.EList(
          ps = __ps.result(),
    ...
    private[this] def __computeSerializedSize(): _root_.scala.Int = {
      ...
      {
        val __value = coop.rchain.models.EList._typemapper_locallyFree.toBase(locallyFree)
        if (!__value.isEmpty) {
    ...
    def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream): _root_.scala.Unit = {
      ...
      {
        val __v = coop.rchain.models.EList._typemapper_locallyFree.toBase(locallyFree)
        if (!__v.isEmpty) {
    ...
    def addPs(__vs: coop.rchain.models.Par *): EList = addAllPs(__vs)
    def addAllPs(__vs: Iterable[coop.rchain.models.Par]): EList = copy(ps = ps ++ __vs)
    def withPs(__v: _root_.scala.Seq[coop.rchain.models.Par]): EList = copy(ps = __v)
    def withLocallyFree(__v: coop.rchain.models.AlwaysEqual[scala.collection.immutable.BitSet]): EList = copy(locallyFree = __v)
    def withConnectiveUsed(__v: _root_.scala.Boolean): EList = copy(connectiveUsed = __v)
    def getRemainder: coop.rchain.models.Var = remainder.getOrElse(coop.rchain.models.Var.defaultInstance)
    def clearRemainder: EList = copy(remainder = _root_.scala.None)
    def withRemainder(__v: coop.rchain.models.Var): EList = copy(remainder = Option(__v))
    def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        case 1 => ps
        case 3 => {
          val __t = coop.rchain.models.EList._typemapper_locallyFree.toBase(locallyFree)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 3 => _root_.scalapb.descriptors.PByteString(coop.rchain.models.EList._typemapper_locallyFree.toBase(locallyFree))
    ...
    def companion: coop.rchain.models.EList.type = coop.rchain.models.EList
    // @@protoc_insertion_point(GeneratedMessage[EList])
}

object EList extends scalapb.GeneratedMessageCompanion[coop.rchain.models.EList] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[coop.rchain.models.EList] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): coop.rchain.models.EList = {
    ...
    coop.rchain.models.EList(
        ps = __ps.result(),
        locallyFree = coop.rchain.models.EList._typemapper_locallyFree.toCustom(__locallyFree),
        connectiveUsed = __connectiveUsed,
        remainder = __remainder
    )
  }
  implicit def messageReads: _root_.scalapb.descriptors.Reads[coop.rchain.models.EList] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      coop.rchain.models.EList(
        ...
        locallyFree = coop.rchain.models.EList._typemapper_locallyFree.toCustom(__fieldsMap.get(scalaDescriptor.findFieldByNumber(3).get).map(_.as[_root_.com.google.protobuf.ByteString]).getOrElse(_root_.com.google.protobuf.ByteString.EMPTY)),
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = RhoTypesProto.javaDescriptor.getMessageTypes().get(16)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = RhoTypesProto.scalaDescriptor.messages(16)
  ...
  lazy val defaultInstance = coop.rchain.models.EList(
    ps = _root_.scala.Seq.empty,
    locallyFree = coop.rchain.models.EList._typemapper_locallyFree.toCustom(_root_.com.google.protobuf.ByteString.EMPTY),
    connectiveUsed = false,
    remainder = _root_.scala.None
  )
  implicit class EListLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.EList]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, coop.rchain.models.EList](_l) {
  ...
  ): _root_.coop.rchain.models.EList = _root_.coop.rchain.models.EList(
    ps,
    locallyFree,
    connectiveUsed,
    remainder
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[EList])
}
