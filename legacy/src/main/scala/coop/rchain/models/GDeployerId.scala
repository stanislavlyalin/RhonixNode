...
final case class GDeployerId(
    ...
    override def equals(x: Any): Boolean = {
     ...
     coop.rchain.models.EqualM[coop.rchain.models.GDeployerId].equals[cats.Eval](this, x).value
    ...
    override def hashCode(): Int = {
     ...
     coop.rchain.models.HashM[coop.rchain.models.GDeployerId].hash[cats.Eval](this).value
