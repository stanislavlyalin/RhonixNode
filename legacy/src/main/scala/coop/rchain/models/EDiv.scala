...
final case class EDiv(
    ...
    def withP1(__v: coop.rchain.models.Par): EDiv = copy(p1 = __v)
    def withP2(__v: coop.rchain.models.Par): EDiv = copy(p2 = __v)
    ...
    def companion: coop.rchain.models.EDiv.type = coop.rchain.models.EDiv
    // @@protoc_insertion_point(GeneratedMessage[EDiv])
}

object EDiv extends scalapb.GeneratedMessageCompanion[coop.rchain.models.EDiv] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[coop.rchain.models.EDiv] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): coop.rchain.models.EDiv = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[coop.rchain.models.EDiv] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = RhoTypesProto.javaDescriptor.getMessageTypes().get(26)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = RhoTypesProto.scalaDescriptor.messages(26)
  ...
  lazy val defaultInstance = coop.rchain.models.EDiv(
    p1 = coop.rchain.models.Par.defaultInstance,
    p2 = coop.rchain.models.Par.defaultInstance
  )
  implicit class EDivLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, coop.rchain.models.EDiv]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, coop.rchain.models.EDiv](_l) {
  ...
  ): _root_.coop.rchain.models.EDiv = _root_.coop.rchain.models.EDiv(
    p1,
    p2
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[EDiv])
}
