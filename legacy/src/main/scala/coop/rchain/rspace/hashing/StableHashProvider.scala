...
import coop.rchain.rspace.serializers.ScodecSerialize.{codecSeqByteVector, toOrderedByteVectors, RichAttempt}
...
//    Blake2b256Hash.create(encodedSeq)
  ...
  def hash[A](channel: ByteVector, datum: A, persist: Boolean)(implicit
