...
final case class TrieInsertProduce[A](hash: Blake2b256Hash, data: Seq[Datum[A]]) extends TrieInsertAction

final case class TrieInsertJoins[C](hash: Blake2b256Hash, joins: Seq[Seq[C]]) extends TrieInsertAction
...
final case class TrieInsertBinaryProduce(hash: Blake2b256Hash, data: Seq[ByteVector]) extends TrieInsertAction

final case class TrieInsertBinaryJoins(hash: Blake2b256Hash, joins: Seq[ByteVector]) extends TrieInsertAction

final case class TrieInsertBinaryConsume(hash: Blake2b256Hash, continuations: Seq[ByteVector]) extends TrieInsertAction
